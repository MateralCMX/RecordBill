...
namespace User.WebAPI
{
    ...
    public class Startup
    {
        ...
        {
            services.AddUserWebAPIServices();
            string basePath = PlatformServices.Default.Application.ApplicationBasePath;
            string[] swaggerHelperXmlPathArray =
            {
                Path.Combine(basePath, "Model.xml"),
                Path.Combine(basePath, "User.WebAPI.xml"),
                Path.Combine(basePath, "User.DataTransmitModel.xml"),
                Path.Combine(basePath, "User.PresentationModel.xml")
            };
