...
namespace RecordBill.DAL
{
    ...
    public sealed class BillDAL : BaseDAL<T_Bill,V_Bill>
    {
        ...
        public IQueryable<V_Bill> GetBillViewInfoByWhere(Guid? userID, DateTime? minDate, DateTime? maxDate)
        {
        ...
        {
            IQueryable<V_Bill> listM = GetBillViewInfoByWhere(userID, minDate, maxDate);
